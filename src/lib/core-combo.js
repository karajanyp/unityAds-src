...
/**
 * ±È¿˙ ˝◊ÈœÓ
 * @param fn {Function} ±È¿˙ªÿµ˜∑Ω∑®
 * @param context {Object} optional. ø…—°£¨ªÿµ˜∑Ω∑®µƒ…œœ¬Œƒ
 */
...
/**
 * Œ™DOMElementÃÌº”ºÊ»›µƒclassList Ù–‘
...
CMD.register("adunit.VastAdUnit", function (require) {
    ...
    /**
     * Ê†πÊçÆ‰∫ã‰ª∂ÂêçÁß∞ËøîÂõûÂØπÂ∫îÁöÑË∑üË∏™ÈìæÊé•
     * @param event {String} ‰∫ã‰ª∂ÂêçÁß∞
     * @returns {String}
     */
...
CMD.register("adunit.view.Privacy", function (require) {
    ...
    var tpl = '' +
        ...
        'OneWay SDK collects and uses information gathered through your use of your apps in order to create an individualized and more relevant user experience, to predict your preferences, and to show you ads that are more likely to interest you (ÔøΩÔøΩpersonalized adsÔøΩÔøΩ).\n' +
        ...
        'You may be able to opt-out of OneWay SDKÔøΩÔøΩ collection and use of your mobile app data for personalized ads through your device settings.\n' +
        '</div>\n' +
        '<% } else { %>\n' +
...
CMD.register("cache.CacheManager", function (require) {
    ...
    /**
     * …æÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ(21ÔøΩÔøΩ«∞)ÔøΩƒªÔøΩÔøΩÊ£¨ÔøΩÔøΩÔøΩÔøΩ÷§ÔøΩÔøΩÔøΩÔøΩÔøΩ–°ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ512Kb
     * @returns {Promise}
     */
    ...
    /**
     * ÔøΩÔøΩÔøΩÔøΩÔøΩƒºÔøΩ¬∑ÔøΩÔøΩÔøΩÔøΩ»°ÔøΩƒºÔøΩid, ÔøΩÔøΩÔøΩÔøΩƒºÔøΩidÔøΩÔøΩÔøΩÔøΩÔøΩ⁄£ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩƒºÔøΩidÔøΩÔøΩÔøΩÔøΩÔøΩÊ°£
     * ÔøΩƒºÔøΩidÔøΩ·ππÔøΩÔøΩÔøΩƒºÔøΩ¬∑ÔøΩÔøΩÔøΩƒπÔøΩœ£ÔøΩÔøΩ[.ÔøΩƒºÔøΩÔøΩÔøΩ◊∫ÔøΩÔøΩ]
     *
     * @param fileUrl {String} ÔøΩƒºÔøΩ¬∑ÔøΩÔøΩ
     * @returns {Promise}
     */
    ...
    /**
     * ÔøΩÔøΩÔøΩƒºÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩœ¢–¥ÔøΩÎ±æÔøΩÿ¥Ê¥¢ÔøΩÔøΩ
     * @param fileUrl       {String} ÔøΩƒºÔøΩ¬∑ÔøΩÔøΩ
     * @param cacheResponse {Object} ÔøΩƒºÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩœ¢
     */
...
CMD.register("event.EventManager", function (require) {
    ...
    /**
     * ÂèëÈÄÅÊâÄÊúâÊú™ÂèëÈÄÅËøáÁöÑsession‰ø°ÊÅØÔºåÊàêÂäüÂêéÂà†Èô§Storage‰ø°ÊÅØ
     * @returns {Promise}
     */
    ...
    /**
     * sessionÊòØÂê¶ËøáÊúüÔºåËøáÊúüÊó∂Èó¥‰∏∫7Â§©
    ...
    /**
     * Ëé∑ÂèñÊâÄÊúâÊú™ÂèëÈÄÅÁöÑ‰∫ã‰ª∂id
     * @param sessionId
    ...
    /**
     * ÂèëÈÄÅ‰∫ã‰ª∂Âà∞nativeÔºåÊàêÂäüÂêéÂà†Èô§StorageÁöÑ‰∫ã‰ª∂ËÆ∞ÂΩï
     * @param sessionId {String}
...
CMD.register("metadata.MetaDataManager", function (require) {
    ...
    /**
     * ¥”±æµÿ¥Ê¥¢¿ÔªÒ»°÷∏∂®¿‡–Õµƒ∂‡∏ˆ‘™ ˝æ›÷µ°£
     * @param category      {String}        ‘™ ˝æ›¿‡–Õ
     * @param keys          {Array}         ‘™ ˝æ›º¸÷µ√˚¡–±Ì
     ...
     * @param keys          {Array}         ‘™ ˝æ›º¸÷µ√˚¡–±Ì
     * @param nativeBridge  {NativeBridge}  Native Api
     * @param useCache      {Boolean}        «∑Ò π”√ª∫¥Ê£¨»Áπ˚Œ™true, ”≈œ» π”√ª∫¥Ê ˝æ›£¨≤¢‘⁄µ⁄“ª¥ŒªÒ»°‘™ ˝æ›µƒÕ¨ ±ª∫¥Ê∆¿¥°£
...
CMD.register("request.Request", function () {
    ...
    /**
     * Ëé∑ÂèñheaderÂÜÖÂÆπÔºåheader‰∏çÂ≠òÂú®ÔºåËøîÂõûnull
     * @param headers   {Object} {Array}  Â§¥ÈÉ®ÂØπË±°ÔºåÂèØ‰ª•‰∏∫ÂØπË±°{headerKey: headerContent}, ÊàñÊï∞ÁªÑ[[headerKey, headerContent],...s]
    ...
    /**
     * Ê≥®ÂÜåÂõûË∞ÉÊñπÊ≥ïÔºåÁî®‰∫éËØ∑Ê±ÇÂÆåÊØïÂêéNativeË∞ÉÁî®
    ...
    /**
     * ÊâßË°åhttpËØ∑Ê±Ç
     * @param callbackId    {Number}    ÂõûË∞Éid
     * @param requestConfig {Object}    ËØ∑Ê±ÇÈÖçÁΩÆ‰ø°ÊÅØ
     * @returns {Promise}
     */
    ...
    /**
     * requestÂÆåÊàêÂêéÊâßË°åÂõûË∞ÉÔºå‰ªéÁ¨¨‰∏â‰∏™ÂèÇÊï∞ÂºÄÂßã‰Ωú‰∏∫ÂõûË∞ÉÊñπÊ≥ïÁöÑÂèÇÊï∞
     * @param callbackId {Number} ÂõûË∞Éid
     * @param callbackState {Number} ÂõûË∞ÉÁä∂ÊÄÅ{0:ÊàêÂäü|1:Â§±Ë¥•}
     */
    ...
    /**
     * ËØ∑Ê±ÇÂ§±Ë¥•ÁöÑÂ§ÑÁêÜÊñπÊ≥ïÔºåÂ¶ÇÊûúËÆæÁΩÆÊúâËØ∑Ê±ÇÈáçËØïÔºåÂàôÈáçËØï
     * @param callbackId    {Number}
...
CMD.register("util.JsonParser", function () {
    ...
    /**
     * Â∞ÜJSONÊ†ºÂºèÁöÑÂ≠óÁ¨¶‰∏≤Ëß£Èáä‰∏∫JSONÂØπË±°
     * @param text      {String}    JSONÂ≠óÁ¨¶‰∏≤
     * @param reviver   {Function}  optional, ÂØπË±°ÂÄºÂ§ÑÁêÜÂáΩÊï∞
     * @returns {Object}
     */
...
CMD.register("util.Url", function (){
    ...
    /**
     * Âú®ÁªôÂÆöÁöÑurl‰∏≠Êü•ËØ¢ÂèÇÊï∞ÂÄº
     * @param url       {String}    url
     * @param paramName {String}    Ë¶ÅÊü•ËØ¢ÁöÑÂèÇÊï∞Âêç
...
CMD.register("webview.bridge.NativeBridge", function(require){
     ...
     * JS Call Native
     *
     * @param nativeClass {String} Native¿‡µƒ¿‡√˚£¨»Á"Broadcast"
     * @param nativeMethod {String} Native∑Ω∑®√˚£¨»Á"addBroadcastListener"
     * @param parameters {Array} Native∑Ω∑®µƒ µ≤Œ¡–±Ì£¨»Á[]
     */
     ...
     * JS Call Native
     *
     * @param nativeFullPathClass {String} Native¿‡µƒ»´¬∑æ∂¿‡√˚£¨»Á"com.unity3d.ads.api.Broadcast"
     * @param nativeMethod {String} Native∑Ω∑®√˚£¨»Á"addBroadcastListener"
     * @param parameters {Array} Native∑Ω∑®µƒ µ≤Œ¡–±Ì£¨»Á[]
     *
    ...
    /**
     * JS Call Native
     * JS∂À≈˙¡øµ˜”√Java∂ÀΩ”ø⁄ className.methodName(parameters)°£
     * µ˜”√ÕÍ±œ∫ÛNative∂Àª·µ˜”√WebViewµƒΩ”ø⁄£∫window.nativeBridge.handleCallback(jsCallbackId, callbackStatus, paramList);
     *
     * @param batch {Array} ≈˙¡ø≤Œ ˝£¨Ω·ππŒ™£∫[[nativeClassName, nativeMethodName, nativeParamList, jsCallbackId]]
     */
    ...
    /**
     * JS Call Native. JS∂Àµ˜”√Native∂ÀΩ”ø⁄
     * JS÷¥––NativeµƒΩ”ø⁄°£‘⁄Androidª∑æ≥÷–£¨ª·µ˜”√“‘œ¬Ω”ø⁄:
     *
     * WebViewBridgeInterface.handleCallback(nativeCallbackId, callbackStatus)
     *
     * @param nativeCallbackId {String} Javaªÿµ˜∑Ω∑®id
     * @param callbackStatus {String} ªÿµ˜◊¥Ã¨£¨◊˜Œ™ µ≤Œ¥´»ÎnativeCallbackIdÀ˘±Ì æµƒ∑Ω∑®÷–
     */
    ...
    /**
     * Native call JS. Native∂Àµ˜”√JS∂ÀΩ”ø⁄
     * ¥À∑Ω∑®”√”⁄Native∂Àµ˜”√JS∂ÀΩ”ø⁄: window.jsClassName.jsMethodName(jsParams).
     * µ˜”√ÕÍ±œ∫ÛJS∂Àª·‘Ÿ¥Œµ˜”√Native∂ÀµƒΩ”ø⁄°£‘⁄Androidª∑æ≥÷–£¨ª·µ˜”√“‘œ¬Ω”ø⁄:
     *
    ...
    /**
     * ¥À∑Ω∑®”√”⁄Native∂Àµ˜”√JS∂ÀΩ”ø⁄(Native call JS)
...
CMD.register("main", function(require){
    ...
    switch (Url.getQueryParameter(location.search, "platform")) {
        case "android":
            //JS µ˜”√ Android API: Ã·π©webviewbridgeΩ”ø⁄
