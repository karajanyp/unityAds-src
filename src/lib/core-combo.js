...
CMD.register("adunit.view.Privacy", function (require) {
    ...
    var tpl = '' +
        ...
        'You may be able to opt-out of Unity Ads°Ø collection and use of your mobile app data for personalized ads through your device settings.\n' +
        '</div>\n' +
        '<% } else { %>\n' +
...
CMD.register("cache.CacheManager", function (require) {
    ...
    /**
     * …æ≥˝π˝∆⁄(21ÃÏ«∞)µƒª∫¥Ê£¨≤¢±£÷§ª∫¥Ê¥Û–°≤ª≥¨π˝512Kb
     * @returns {Promise}
     */
    ...
    /**
     * ∏˘æ›Œƒº˛¬∑æ∂ªÒ»°Œƒº˛id, »Áπ˚Œƒº˛id≤ª¥Ê‘⁄£¨‘Ú…˙≥…Œƒº˛id≤¢ª∫¥Ê°£
     * Œƒº˛idΩ·ππ£∫Œƒº˛¬∑æ∂µƒπ˛œ£¬Î[.Œƒº˛∫Û◊∫√˚]
     *
     * @param fileUrl {String} Œƒº˛¬∑æ∂
     * @returns {Promise}
     */
     ...
     * Ω´Œƒº˛ª∫¥Ê–≈œ¢–¥»Î±æµÿ¥Ê¥¢÷–
     * @param fileUrl       {String} Œƒº˛¬∑æ∂
     * @param cacheResponse {Object} Œƒº˛ª∫¥Ê–≈œ¢
     */
